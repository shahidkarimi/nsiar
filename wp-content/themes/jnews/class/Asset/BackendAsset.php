...
Class BackendAsset extends AssetAbstract
{
    ...
    public function load_jnews_library() {
		$script = $this->load_file( get_parent_theme_file_path( 'assets/js/jnewslibrary.js' ) );
    ...
    public function backend_script()
    {
        ...
        if(defined('JNEWS_ESSENTIAL')){
            ...
            if($pagenow === 'post.php' || $pagenow === 'post-new.php') {
                wp_enqueue_script( 'jnews-post',        $asset_url . 'js/admin/jnews.post.js', $theme_version, true);
            }
        ...
        if($pagenow === 'admin.php' || $pagenow === 'themes.php') {
            ...
            wp_enqueue_script('jnews-dashboard',        $asset_url . 'js/admin/jnews.dashboard.js', $wp_util, $theme_version, true);
