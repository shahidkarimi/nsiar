...
if ( function_exists( 'vc_asset_url' ) ) {
	$options[] = array(
		...
		'default'         => false,
		'type'            => 'jnews-toggle',
		'label'           => esc_html__( 'Enable Font Preloading for Visual Composer', 'jnews' ),
		'description'     => esc_html__( 'Remove any flash of unstyled text/icon ( FOUT ) on Visual Composer.', 'jnews' ),
		'active_callback' => array(
			array(
