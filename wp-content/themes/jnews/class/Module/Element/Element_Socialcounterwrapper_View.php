...
Class Element_Socialcounterwrapper_View extends ModuleViewAbstract
{
    ...
    {
    	global $social_vk_id, $social_vk_token, $social_fb_key, $social_gg_key, $social_bh_key, $social_twitch_key, $social_rss_count, $social_new_tab, $tw_consumer_key, $tw_consumer_secret, $tw_access_token, $tw_access_token_secret;
